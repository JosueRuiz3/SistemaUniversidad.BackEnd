...
EXEC sp_addextendedproperty
	@name = N'MS_Description',	@value = 'Profesores que el sistema de universidad gestiona',
   	@level0type = N'Schema',	@level0name = 'dbo',
  	@level1type = N'Table',		@level1name = 'Profesores'
GO
...
GO
EXEC sp_addextendedproperty 
	@name = N'MS_Description',	@value = 'Profesión',
   	@level0type = N'Schema',	@level0name = 'dbo',
   	@level1type = N'Table',		@level1name = 'Profesores', 
